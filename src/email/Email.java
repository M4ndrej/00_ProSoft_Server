...
public class Email {
    ...
    private MimeMessage draft1(double staraDoznaka, double novaDoznaka, Menadzer menadzer, Lokalitet lokalitet) throws AddressException, MessagingException {
        String primalac = "andrejmax347@gmail.com";

        String subject = "Promena doznake";

        String teloPoruke = "Poštovani, obaveštavamo Vas da je na gazdinskoj jedinici " + lokalitet.getJedinicaGazdinstva().toString() + ",\n"
                + " za odsek i odeljenje " + lokalitet.getOdsekOdeljenje().toString() + ", izvršena izmena doznačene količine.\n"
    ...
    public static void promeniDoznaku(double staraDoznaka, double novaDoznaka, Menadzer menadzer, Lokalitet lokalitet) throws MessagingException {
        Email por = new Email();
        por.postaviPropertie();
        por.draft1(staraDoznaka, novaDoznaka, menadzer, lokalitet);
        por.posalji();
    }
